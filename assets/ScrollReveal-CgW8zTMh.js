import{m as f,d as m,l as d,j as l}from"./index-DjLqk89H.js";import{r as c}from"./vendor-CdEpWVL-.js";const p=()=>typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,I=({threshold:t=.1,rootMargin:n="0px",triggerOnce:e=!0}={})=>{const r=c.useRef(null),[i,o]=c.useState(!1);return c.useEffect(()=>{const s=r.current;if(!s)return;if(p()){o(!0);return}const a=new IntersectionObserver(([u])=>{u.isIntersecting?(o(!0),e&&a.unobserve(s)):e||o(!1)},{threshold:t,rootMargin:n});return a.observe(s),()=>{a.unobserve(s)}},[t,n,e]),{ref:r,isInView:i}},w=f`
  from {
    opacity: 0;
